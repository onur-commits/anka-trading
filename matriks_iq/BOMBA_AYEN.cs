...
{
    // 2026-04-02 - Bomba Skor: 60/100
    // Sebepler: 🧠 ML:79% GÜÇLÜ + 📊 Hacim x1.9 + 🏦 KURUMSAL ALIM + 🚀 İVME DÖNÜŞÜ
    public class BOMBA_AYEN : MatriksAlgo
    {
        [SymbolParameter("AYEN")]
        ...
        {
            Debug("BOMBA_AYEN AKTIF - Skor:60");
        }
