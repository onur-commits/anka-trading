...
{
    // 2026-04-02 - Bomba Skor: 45/100
    // Sebepler: 🔥 SIKIŞMA + 🏦 KURUMSAL ALIM + 🚀 İVME DÖNÜŞÜ + ✨ TAM TREND
    public class BOMBA_KORDS : MatriksAlgo
    {
        [SymbolParameter("KORDS")]
        ...
        {
            Debug("BOMBA_KORDS AKTIF - Skor:45");
        }
