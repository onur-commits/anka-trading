...
{
    // 2026-04-02 - Bomba Skor: 48/100
    // Sebepler: 🧠 ML:68% + 📊 Hacim x2.3 + 🚀 İVME DÖNÜŞÜ + ✨ TAM TREND
    public class BOMBA_AKSEN : MatriksAlgo
    {
        [SymbolParameter("AKSEN")]
        ...
        {
            Debug("BOMBA_AKSEN AKTIF - Skor:48");
        }
