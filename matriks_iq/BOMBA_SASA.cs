...
{
    // 2026-04-01 - Bomba Skor: 56/100
    // Sebepler: 🧠 ML:61% + ⬇️ RSI7:27 + 🔥 SIKIŞMA + 📊 Hacim x1.7
    public class BOMBA_SASA : MatriksAlgo
    {
        [SymbolParameter("SASA")]
        ...
        {
            Debug("BOMBA_SASA AKTIF - Skor:56");
        }
