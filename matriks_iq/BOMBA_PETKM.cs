...
{
    // 2026-04-02 - Bomba Skor: 43/100
    // Sebepler: 🧠 ML:62% + 🚀 İVME DÖNÜŞÜ + ✨ TAM TREND
    public class BOMBA_PETKM : MatriksAlgo
    {
        [SymbolParameter("PETKM")]
        ...
        {
            Debug("BOMBA_PETKM AKTIF - Skor:43");
        }
