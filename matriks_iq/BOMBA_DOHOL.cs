...
{
    // 2026-04-02 - Bomba Skor: 58/100
    // Sebepler: 🧠 ML:68% + 🔥 SIKIŞMA + 📊 HACİM PATLAMA + 🏦 KURUMSAL ALIM
    public class BOMBA_DOHOL : MatriksAlgo
    {
        [SymbolParameter("DOHOL")]
        ...
        {
            Debug("BOMBA_DOHOL AKTIF - Skor:58");
        }
